...
public class Autolabel_platformFrameworksBase {
	...
	public static void main(String[] args) throws IOException {
		 ...
		 * Git Log 파일 생성
		 */
		String DIR = "D:\\\\develop2\\\\workspace_ai\\\\platform_frameworks_base\\";
		...
		for(Commit commit : commits) {
			System.out.println("[PlfFB]index : " + ++index);
			/**
			 * 커밋관련 파일 생성
			 */
			...
			for(int i=0; i<filelist.size(); i++) {
				...
				java.nio.file.Files.createDirectories(Paths.get("D:\\\\develop2\\\\workspace_ai\\\\platform_frameworks_base", "commits"));
				java.nio.file.Files.createDirectories(Paths.get("D:\\\\develop2\\\\workspace_ai\\\\platform_frameworks_base", "commits", hash));
				String command = "";
				// 이전파일 출력
				command  = "git show " + hash_ + ":" + filepath;
		        Process p = Runtime.getRuntime().exec(command, null, new File("D:\\develop2\\workspace_ai\\platform_frameworks_base"));
...
//		            if(isDebug) System.out.println("Line: " + line);
		        ...
		        p = Runtime.getRuntime().exec(command, null, new File("D:\\develop2\\workspace_ai\\platform_frameworks_base"));
...
//		            if(isDebug) System.out.println("Line: " + line);
		         ...
		         * 소스 변경 내용 추출
		         */
		        File left = new File("D:\\develop2\\workspace_ai\\platform_frameworks_base\\" + file1);
				File right = new File("D:\\develop2\\workspace_ai\\platform_frameworks_base\\" + file2);
